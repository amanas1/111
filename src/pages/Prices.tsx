...
const priceCategories: PriceCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Установка газового котла", unit: "за услугу", price: "от 15 000 ₸", popular: true },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col pt-16 md:pt-20">
      <SEO 
        ...
        description="Актуальный прайс-лист на все виды сантехнических и электрических услуг в Алматы. Прозрачные цены, без скрытых платежей. Выезд и диагностика — бесплатно!"
      />
