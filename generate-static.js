...
seoData.services.forEach(service => {
  seoData.districts.forEach(district => {
    // Generate Metadata
    const title = `${service.title} в ${district.name} районе | Мастер Алматы 24/7`;
    const description = `Срочный ${service.title.toLowerCase()} в ${district.name} районе Алматы. Выезд за 30 мин! Гарантия на работы до 1 года. Звоните ☎ +7 (705) 553-53-32`;
...
console.log(`✅ Static pre-rendering complete. Generated ${generatedCount} HTML pages for SEO.`);
