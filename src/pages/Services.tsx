...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <SEO 
        title="Все услуги сантехника и электрика в Алматы | Мастер Манас"
        description="Полный перечень услуг сантехника и электрика в Алматы. От мелкого ремонта до сложных монтажных работ. Профессионально, с гарантией, недорого."
      />
      ...
      <section className="bg-[#0095DA] text-white py-16 relative">
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Выполняем полный комплекс сантехнических и электромонтажных работ в Алматы любой сложности. Даем официальную гарантию на все виды работ.
          </p>
        </div>
      </section>
