...
const serviceData: Record<string, { name: string; services: { name: string; basePrice: number }[] }> = {
  ...
  heating: {
    ...
    services: [
      ...
      { name: "Установка газового котла", basePrice: 15000 },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <SEO
        ...
        description="Онлайн-калькулятор стоимости сантехнических и электрических услуг в Алматы. Узнайте точную цену работ прямо сейчас!"
      />
